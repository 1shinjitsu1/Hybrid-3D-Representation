config = {
    ...
    'collections': [                                        # Parameters to set with the distribution defined above                              
        {
            'name': 'Curls',                               # Patch name, needs to match the name of the instancer in the corresponding .blend file
    ...
    'target_path': 'datasets/materials/curls2'              # Path where the generated files are stored to
}
