config = {
    ...
    'collections': [                                        # Parameters to set with the distribution defined above                              
        {
            'name': 'Catfur',                               # Patch name, needs to match the name of the instancer in the corresponding .blend file
    ...
    'pose_file_save_interval': 10,                          # Number of generated samples after which to save poses
    'target_path': 'datasets/materials/catfur'              # Path where the generated files are stored to
}
